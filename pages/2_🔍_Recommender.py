...
st.write("###### Warning 🔇!  if you can't listen the songs on the phone , you may need an apple music subscription ")
...
with st.container():
    ...
    if st.button('get recommendation',key=1):
        ...
        for song_url in song_html:
            components.iframe(song_url, height=60, scrolling=True)
